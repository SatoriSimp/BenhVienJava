...
public class Rotchaser extends Enemy {
    ...
    public Rotchaser() {
        if (Math.floor(Math.random() * (100 - 1 + 1) + 1) > 25) {
            setName("Rotchaser");
            setTrait("Creation of the Sanguinaria, fast-movement and surprisingly resilient despite their look.\n" +
            ...
            setTrait("Creation of the Sanguinaria, more nimble and resilient, even among their kins.\n" +
                    "They don't understand the concept of living and such, and it's not like they need to.\n" +
                    "Thoughts are incompatible with death, and they never stop.");
            setMaxHealth(10000);
            setAtk((short) 600);
